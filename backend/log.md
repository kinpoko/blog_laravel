...
## 2021-06-17 descriptionを生成

### 方法

記事を表示する際に記事の本文からHTMLタグを除去して一定の数抽出し、それをheadのdesicriptionとする

`FrontBlogController.php`の`showpost`を以下のように修正
